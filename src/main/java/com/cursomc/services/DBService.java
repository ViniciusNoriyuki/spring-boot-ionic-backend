...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Cliente cli1 = new Cliente(null, "Pedro Henrique", "viniciusnoriyuki10@gmail.com", "1231241928", TipoCliente.PESSOAFISICA);
        ...
        Pedido ped1 = new Pedido(null, sdf.parse("30/09/2020 10:30"), cli1, end1);
        Pedido ped2 = new Pedido(null, sdf.parse("10/10/2019 19:35"), cli1, end2);

        Pagamento pag1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
        ped1.setPagamento(pag1);

        Pagamento pag2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("10/12/2019 00:00"), null);
